...
/*   Updated: 2024/01/29 14:30:13 by mde-clee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	link_data(t_nav *nav, t_obj *obj)
{
	...
	(nav[8]).cont.float_number = &obj->shape.cone->ctr.x;
	(nav[9]).cont.float_number = &obj->shape.cone->ctr.y;
	(nav[10]).cont.float_number = &obj->shape.cone->ctr.z;
	(nav[11]).cont.float_number = &obj->shape.cone->axis.x;
	(nav[12]).cont.float_number = &obj->shape.cone->axis.y;
	(nav[13]).cont.float_number = &obj->shape.cone->axis.z;
	(nav[14]).cont.float_number = &obj->shape.cone->diameter;
	(nav[15]).cont.float_number = &obj->shape.cone->height;
