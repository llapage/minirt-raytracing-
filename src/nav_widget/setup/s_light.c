...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/18 23:18:06 by mde-clee          #+#    #+#             */
/*   Updated: 2024/01/29 14:34:35 by mde-clee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(nav[3]).cont.float_number = &lux->src.spot->pos.x;
	(nav[4]).cont.float_number = &lux->src.spot->pos.y;
	(nav[5]).cont.float_number = &lux->src.spot->pos.z;
...
{
	set_nav(nav, NAV3FLT, "LOCATION", nav_dir(0, 1, -1, 3));
